...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    value: {},
    placeholder: { default: "Select blocks from this page" }
  },
  emits: ["input"],
  setup(__props, { emit: __emit }) {
    ...
    const fetchPageBlocks = async () => {
      ...
      try {
        ...
        const blocksWithData = await Promise.all(
          response.data.data.filter((block) => block.id !== (values == null ? void 0 : values.id)).map(async (block) => {
            ...
            try {
              ...
              const displayName = (itemData == null ? void 0 : itemData.headline) || (itemData == null ? void 0 : itemData.title) || (itemData == null ? void 0 : itemData.heading) || (itemData == null ? void 0 : itemData.name) || (itemData == null ? void 0 : itemData.eyebrow) || (itemData == null ? void 0 : itemData.tagline) || (itemData == null ? void 0 : itemData.eyebrow_heading) || (itemData == null ? void 0 : itemData.subheading) || (itemData == null ? void 0 : itemData.label) || // Then check for specific content indicators
              ((itemData == null ? void 0 : itemData.numOfColumns) ? `${itemData.numOfColumns} columns` : null) || ((itemData == null ? void 0 : itemData.alignment) ? `Alignment: ${itemData.alignment}` : null) || ((itemData == null ? void 0 : itemData.text) ? itemData.text.substring(0, 50) + "..." : null) || ((itemData == null ? void 0 : itemData.content) ? itemData.content.substring(0, 50) + "..." : null) || // Fallback to any string field that might be meaningful
              (() => {
                const stringFields = Object.entries(itemData || {}).filter(
                  ([key, value]) => typeof value === "string" && value.length > 0 && value.length < 100 && !key.includes("id") && !key.includes("date") && !key.includes("user")
                );
                return stringFields.length > 0 ? stringFields[0][1] : "Untitled Block";
              })();
              const blockType = block.collection.replace("block_", "").replace(/_/g, " ").replace(/\b\w/g, (l) => l.toUpperCase());
              const result = {
                id: block.id,
        ...
        console.log(
          ...
          (_a = availableBlocks.value[0]) == null ? void 0 : _a.display_name
        );
        updateSortedBlocks();
    ...
    const updateSortedBlocks = () => {
      ...
      sortedBlocks.value = selectedBlocks.value.map((id) => availableBlocks.value.find((block) => block.id === id)).filter(Boolean);
    };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        ...
        availableBlocks.value.length > 0 ? (openBlock(), createElementBlock(
          "div",
          _hoisted_1,
          " Available blocks: " + toDisplayString(availableBlocks.value.length) + " | Sample: " + toDisplayString(((_a = availableBlocks.value[0]) == null ? void 0 : _a.display_name) || "No display name"),
          1
          /* TEXT */
        ...
        sortedBlocks.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_11, [
          ...
          createVNode(unref(draggable), {
            modelValue: sortedBlocks.value,
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => sortedBlocks.value = $event),
            "item-key": "id",
            onChange: handleSort,
            class: "space-y-2"
          }, {
            item: withCtx(({ element }) => [
              createElementVNode("div", _hoisted_12, [
                ...
                createElementVNode(
                  "span",
                  null,
                  toDisplayString(element.display_name),
                  1
                  /* TEXT */
                ),
                createVNode(_component_v_btn, {
                  ...
                  size: "small",
                  variant: "text",
                  onClick: ($event) => removeBlock(element.id),
                  class: "ml-auto"
                }, {
                  default: withCtx(() => [
